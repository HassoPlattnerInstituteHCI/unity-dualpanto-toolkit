...
public class OldMan : MonoBehaviour
{
    ...
    {
        await manager.OldManSpeak("I see you found the bow. Go outside to the tree and practise shooting");
        await manager.OldManSpeak("You can fire the bow by saying fire. I will show you the way."); //Navi
    ...
    async void oldManQuest()
    {
        ...
        await manager.OldManSpeak("Ok Link I will show you the way."); //Navi
                                                                       //.then(() => device.movePantoTo(1, new Vector(-112, -122, 0), naviMoveSpeed))
