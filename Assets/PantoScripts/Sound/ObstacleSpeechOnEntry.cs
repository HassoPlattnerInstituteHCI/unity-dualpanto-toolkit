...
{
    /// <summary>
    /// Plays speech when the PantoHandle enters a obstacle. 
    /// !!! Obstacle should have a unity collider with "Is Trigger" enabled. !!!
    /// </summary>
    public class ObstacleSpeechOnEntry : MonoBehaviour
    {
        ...
        {
            Debug.Log(this.gameObject.name + " entered by: " + other.gameObject.name);
